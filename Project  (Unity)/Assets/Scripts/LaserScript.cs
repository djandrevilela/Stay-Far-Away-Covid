...
public class LaserScript : MonoBehaviour
{
    ...
    public Exponential expo = new Exponential(0.1327);
    ...
    void Update()
    {
        ...
        //7
        float randomExpo = (float) expo.Sample();
        transform.RotateAround(transform.position, Vector3.forward, rotationSpeed * randomExpo/*Time.deltaTime*/);
    }
}
